...
def backtest_config():
    return {
        ...
        "strategies": {
            ...
            "ema_rsi_volume": {"enabled": False, "symbols": [], "timeframe": "15min",
                                "ema_short": 9, "ema_long": 21, "rsi_period": 14,
                                "rsi_buy_threshold": 55, "rsi_sell_threshold": 45,
                                "volume_multiplier": 1.5, "stop_loss_pct": 1.5,
                                "trailing_stop_enabled": True, "trailing_breakeven_at_pct": 2.0,
                                "trailing_activate_at_pct": 3.0, "trailing_distance_pct": 1.5,
